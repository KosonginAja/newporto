...
const Home = () => {
  return (
    <AnimatedContent distance={-150} direction="horizontal" duration={1}>
      <div className="min-h-screen w-full flex flex-col justify-center items-start px-4 sm:px-8 md:px-16 lg:px-32">
        ...
        <div className="links flex gap-10 bg-transparent">
          <p className="group relative w-max">
            ...
            <span className="absolute -bottom-1 left-1/2 w-0 transition-all h-0.5 bg-blue-400 group-hover:w-3/6"></span>
            <span className="absolute -bottom-1 right-1/2 w-0 transition-all h-0.5 bg-blue-400 group-hover:w-3/6"></span>
          </p>
          <p className="group relative w-max">
